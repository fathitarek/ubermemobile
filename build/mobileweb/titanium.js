...
var require = {
	app: {
		analytics: true,
		copyright: "2016 by nouran",
		deployType: "development",
		description: "",
		guid: "31b4c7bf-0316-46d0-9222-72f370c0083f",
		id: "com.uberme",
		name: "uberme",
		names: {},
		publisher: "nouran",
...
require("Ti/App/Properties", function(p) {
	...
	p.setString("appc-app-id","5759366cfd96769a2f5fc45a");
	...
	p.setString("acs-oauth-secret-development","C26Z8scUupJbuHd8RC5P1pHeFq9sdW5S");
	p.setString("acs-oauth-key-development","DHlqsLrUKrFmfF15QziSKTP8CZg3t8d1");
	p.setString("acs-api-key-development","EISxrjXCYWUu968bNHVXqC3Qkjgibzir");
	p.setString("acs-username-development","appc_app_user_dev");
	p.setString("acs-password-development","cuARibCmqP59KQRo4w");
	...
	p.setString("acs-oauth-secret-production","3LdLPI4tSL1iDNHzcciikqLnT7iLn1gN");
	p.setString("acs-oauth-key-production","63rvphXupZQoPFS1KYncbZhcAbCFCYtP");
	p.setString("acs-api-key-production","zBMY3yoxOwAUfIp13j2f01bvseKxT93y");
	p.setString("acs-username-production","appc_app_user");
	p.setString("acs-password-production","cxA7ap3tsNrZeQA6H2");
	p.setString("appc-org-id","100098752");
	p.setString("appc-creator-user-id","1cb941d8-a876-44fa-ac0e-d7e2bf900723");
});
